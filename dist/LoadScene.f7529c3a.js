...
},{}],"src/LoadScene.ts":[function(require,module,exports) {
"use strict";
  ...
  LoadScene.prototype.create = function () {
    ...
    for (var i = 0; i < this.maze.length; i++) {
      ...
      for (var j = 0; j < this.maze[i].length; j++) {
        var room = this.maze[i][j];

        if (!room.top) {
          if (!room.left) {
            if (!room.right == true) {
              if (!room.bottom) {
                mazeRooms[i][j] = this.add.image(j * 100 + 100, i * 100 + 100, cst_1.cst.image.ui.cross);
              } else {
                mazeRooms[i][j] = this.add.image(j * 100 + 100, i * 100 + 100, cst_1.cst.image.ui.teeT);
              }
            } else if (!room.bottom) {
              mazeRooms[i][j] = this.add.image(j * 100 + 100, i * 100 + 100, cst_1.cst.image.ui.teeL);
            } else {
              mazeRooms[i][j] = this.add.image(j * 100 + 100, i * 100 + 100, cst_1.cst.image.ui.turnTL);
            }
          } else if (!room.right) {
            if (!room.bottom) {
              mazeRooms[i][j] = this.add.image(j * 100 + 100, i * 100 + 100, cst_1.cst.image.ui.teeR);
            } else {
              mazeRooms[i][j] = this.add.image(j * 100 + 100, i * 100 + 100, cst_1.cst.image.ui.turnTR);
            }
          } else if (!room.bottom) {
            mazeRooms[i][j] = this.add.image(j * 100 + 100, i * 100 + 100, cst_1.cst.image.ui.straightV);
          } else {
            mazeRooms[i][j] = this.add.image(j * 100 + 100, i * 100 + 100, cst_1.cst.image.ui.endT);
          }
        } else if (!room.left) {
          if (!room.right) {
            if (!room.bottom) {
              mazeRooms[i][j] = this.add.image(j * 100 + 100, i * 100 + 100, cst_1.cst.image.ui.teeB);
            } else {
              mazeRooms[i][j] = this.add.image(j * 100 + 100, i * 100 + 100, cst_1.cst.image.ui.straightH);
            }
          } else if (!room.bottom) {
            mazeRooms[i][j] = this.add.image(j * 100 + 100, i * 100 + 100, cst_1.cst.image.ui.turnBL);
          } else {
            mazeRooms[i][j] = this.add.image(j * 100 + 100, i * 100 + 100, cst_1.cst.image.ui.endL);
          }
        } else if (!room.right) {
          if (!room.bottom) {
            mazeRooms[i][j] = this.add.image(j * 100 + 100, i * 100 + 100, cst_1.cst.image.ui.turnBR);
          } else {
            mazeRooms[i][j] = this.add.image(j * 100 + 100, i * 100 + 100, cst_1.cst.image.ui.endR);
          }
        } else if (!room.bottom) {
          mazeRooms[i][j] = this.add.image(j * 100 + 100, i * 100 + 100, cst_1.cst.image.ui.endB);
        }
      }
    }
  };
...
},{"./cst":"src/cst.ts","generate-maze":"node_modules/generate-maze/dist/generate-maze.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/LoadScene.ts"], null)
//# sourceMappingURL=/LoadScene.f7529c3a.js.map